...
var ItemNay = external_styled_components_default.a.div(room2_templateObject4()); // const Icon = styled.div`
// 	position: relative;
// 	display: flex;
// 	flex-basis:calc(15% - 4rem);
// 	flex-grow: 1;
  ...
  _createClass(Room2, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        select = external_react_default.a.createElement(room2_Item, null, external_react_default.a.createElement(Checkbox, {
          type: "checkbox",
        ...
        select = external_react_default.a.createElement(ItemNay, null, external_react_default.a.createElement(Checkbox, {
          type: "checkbox",
          onClick: function onClick() {
            return _this2.getStuff();
          }
