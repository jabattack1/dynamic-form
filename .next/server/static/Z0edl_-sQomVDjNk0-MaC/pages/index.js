...
var Checkbox = external_styled_components_default.a.input(room2_templateObject()); // &:hover ${GridItem} {
//   	visibility:hidden;
//  	}

var room2_GridItem = external_styled_components_default.a.div(room2_templateObject2());
var room2_Item = external_styled_components_default.a.div(room2_templateObject3(), Checkbox); // const Icon = styled.div`
// 	position: relative;
// 	display: flex;
// 	flex-basis:calc(15% - 4rem);
// 	flex-grow: 1;
...
function (_React$Component) {
  ...
  _createClass(Room2, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(room2_GridItem, null, external_react_default.a.createElement(Checkbox, {
        type: "checkbox",
        onClick: function onClick() {
          return _this2.getStuff();
        }
      }), external_react_default.a.createElement(room2_Box, null, external_react_default.a.createElement(Heading2, null, "Room ", this.state.room), select));
    }
  }, {
