  ...
  _createClass(Room4, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        elect = external_react_default.a.createElement("div", null, console.log(this.props.rooms), external_react_default.a.createElement("label", null, external_react_default.a.createElement("input", {
          type: "checkbox",
...
function (_React$Component) {
  ...
  function Parent(props) {
    ...
    _this.FieldEditor1 = external_react_default.a.createRef();
    return _this;
  }
