...
function (_React$Component) {
  ...
  function Room1(props) {
    ...
    console.log('magic');
    console.log(_this.props.data.props.peter.room1);
    _this.state = {
      room: 1,
...
/* harmony default export */ var components_room1 = (room1_Room1);
...
/* harmony default export */ var components_room2 = (room2_Room2);
...
/* harmony default export */ var components_room3 = (room3_Room3);
...
function (_React$Component) {
  ...
  function Room4(props) {
    ...
    _this.state = {
      check: _this.props.check,
      room: 4,
      adults: _this.state.adults || _this.props.adults,
      children: _this.state.children || _this.props.children
    };
    return _this;
  }
...
/* harmony default export */ var components_room4 = (room4_Room4);
...
function (_React$Component) {
  ...
  function Parent(props) {
    ...
    if (_this.props.peter !== null) {
      console.log('data');
      var roomNumber = _this.props.peter.checked;
      var room1 = _this.props.peter.room1;
      var room1Guests = [];

      for (var key in room1) {
        if (room1.hasOwnProperty(key)) {
          var value = room1[key];
          room1Guests.push(value);
        }
      }

      var room2 = _this.props.peter.room2;
      var room2Guests = [];

      for (var key in room1) {
        if (room2.hasOwnProperty(key)) {
          var value = room2[key];
          room2Guests.push(value);
        }
      }

      var room3 = _this.props.peter.room3;
      var room3Guests = [];

      for (var key in room1) {
        if (room3.hasOwnProperty(key)) {
          var value = room3[key];
          room3Guests.push(value);
        }
      }

      var room4 = _this.props.peter.room4;
      var room4Guests = [];

      for (var key in room1) {
        if (room4.hasOwnProperty(key)) {
          var value = room4[key];
          room4Guests.push(value);
        }
      }
      ...
      _this.state = {
        checked: roomNumber,
        room1: {
          adults: room1Guests[0],
          children: room1Guests[1]
        },
        room2: {
          adults: room2Guests[0],
          children: room2Guests[1]
        },
        room3: {
          adults: room3Guests[0],
          children: room3Guests[1]
        },
        room4: {
          adults: room4Guests[0],
          children: room4Guests[1]
        }
      };
    } else {
      console.log('not');
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      ...
      if (this.state.checked === 2) {
        children = external_react_default.a.createElement("gridWrap", null, external_react_default.a.createElement(components_room1, {
          fromChildToParentCallback: room1Value
        }), external_react_default.a.createElement(components_room2, {
          fromChildToParentCallback: room2Value,
          check: true
        }), external_react_default.a.createElement(components_room3, {
          fromChildToParentCallback: room3Value,
          check: false
        }), external_react_default.a.createElement(components_room4, {
