...
var pages_Index = function Index(props) {
  return external_react_default.a.createElement(Wrap, null, console.log(props), props.rooms[0].map(function (room, i) {
    return external_react_default.a.createElement(room1, _extends({}, props, {
      key: i,
      i: i,
      room: room
    }));
