...
function (_React$Component) {
  ...
  function Room2() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(Room2)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function Room3() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(Room3)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function (_React$Component) {
  ...
  function Room4() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(Room4)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Room4, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        select = external_react_default.a.createElement("div", null, console.log(this), external_react_default.a.createElement("label", null, external_react_default.a.createElement("input", {
          type: "checkbox",
        ...
        }, external_react_default.a.createElement("option", null, "0"), external_react_default.a.createElement("option", null, "1"), external_react_default.a.createElement("option", null, "2")), external_react_default.a.createElement("div", {
          onClick: function onClick() {
            return _this2.props.fromChildToParentCallback(42);
          }
        }, "Click me"));
      } else {
        select = external_react_default.a.createElement("div", null, console.log(this.props), external_react_default.a.createElement("label", null, external_react_default.a.createElement("input", {
          type: "checkbox",
          onClick: function onClick() {
            return _this2.getStuff();
          }
          ...
          onClick: function onClick() {
            return _this2.props.fromChildToParentCallback(_this2.state.check);
          }
        }, "Click me"));
      }
...
function (_React$Component) {
  ...
  function Parent() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf_getPrototypeOf(Parent)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Parent, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(room1, this.props), external_react_default.a.createElement(room2, this.props), external_react_default.a.createElement(room3, this.props), external_react_default.a.createElement(room4, _extends({}, this.props, {
