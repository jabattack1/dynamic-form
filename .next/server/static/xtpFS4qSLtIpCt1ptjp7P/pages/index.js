...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    // 	let data = await Component.getInitialProps(parsedData);
    // 	return data;
    // }
    value: function render(props) {
      return external_react_default.a.createElement(Wrap, null, console.log('steve'), external_react_default.a.createElement(components_parent, null));
    }
  }]);
