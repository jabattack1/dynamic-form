...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      var select = ''; // function single(room) {
      // 	console.log(room);
      // 	let i;
      // 	return [
      // 		...state.slice(0,i), 
      // 		{...state[i], check: state[i].check},
      // 		...state.slice(i+1), 
      // 	]
      // }

      if (this.props.rooms !== 'BAhvZrRwcfu') {
        select = external_react_default.a.createElement("div", null, external_react_default.a.createElement("input", {
          type: "checkbox",
          id: this.props.rooms,
          onClick: single.bind(null, this.props)
      ...
      return external_react_default.a.createElement(Grid, null, external_react_default.a.createElement(Box, null, console.log(this.props), select));
    }
  }]);
