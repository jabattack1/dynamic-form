...
function (_React$Component) {
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      ...
      var children = ''; // console.log(this);

      if (this.state.checked === 'room2') {
        children = external_react_default.a.createElement("div", null, external_react_default.a.createElement(room1, {
      ...
      return external_react_default.a.createElement("div", null, children, external_react_default.a.createElement("button", {
        type: "button",
        onClick: function onClick() {
...
var Wrap = external_styled_components_default.a.div(pages_templateObject()); // const Index = (props) => (
// 	<Wrap>
// 		<Parent {...props} />
// 	</Wrap>
// );
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render(props) {
      external_react_default.a.createElement(Wrap, null, external_react_default.a.createElement(components_parent, props));
    }
  }, {
    key: "componentDidMount",
    value: function componentDidMount() {
  ...
  return Index;
}(external_react_default.a.Component); // Index.getInitialProps = async function() {
// 	console.log('hey');
// 	const data = rooms
// 	return data
// }
