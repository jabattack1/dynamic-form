  ...
  _createClass(Room4, [{
    ...
    value: function getStuff() {
      this.setState({
        ...
        this.props.fromChildToParentCallback([this.state.check, this.state.room, 0, this.state.children]);
      });
    }
  }]);
...
function (_React$Component) {
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", null, children);
    }
  }]);
