...
var pages_Index = function Index(props) {
  return external_react_default.a.createElement(Wrap, null, console.log(pages_this), external_react_default.a.createElement(components_parent, props), "}");
};
