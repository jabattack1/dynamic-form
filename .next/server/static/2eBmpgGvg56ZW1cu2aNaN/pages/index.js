...
function (_React$Component) {
  ...
  _createClass(Room1, [{
    ...
    value: function render() {
      ...
      var select = '';
      select = external_react_default.a.createElement("div", null, external_react_default.a.createElement("p", null, "Adults 18+"), function () {
    ...
    value: function getStuff() {
      this.setState({
        ...
        this.props.fromChildToParentCallback(this.state.check);
        this.props.fromChildToParentCallback(this.state.room);
...
function (_React$Component) {
  ...
  function Parent() {
    ...
    _defineProperty(_assertThisInitialized(_this), "room1Value", function (value) {
      console.log("room1: " + value);
    });

    _defineProperty(_assertThisInitialized(_this), "room2Value", function (value) {
      console.log("room2: " + value);
    });

    _defineProperty(_assertThisInitialized(_this), "room3Value", function (value) {
      console.log("room3: " + value);
    });

    _defineProperty(_assertThisInitialized(_this), "room4Value", function (value) {
  ...
  _createClass(Parent, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(room1, _extends({}, this.props, {
        fromChildToParentCallback: this.room1Value
      })), external_react_default.a.createElement(room2, _extends({}, this.props, {
        fromChildToParentCallback: this.room2Value
      })), external_react_default.a.createElement(room3, _extends({}, this.props, {
        fromChildToParentCallback: this.room3Value
      })), external_react_default.a.createElement(room4, _extends({}, this.props, {
        fromChildToParentCallback: this.room4Value
      })));
    }
  }]);
