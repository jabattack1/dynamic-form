...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      var select = '';
      console.log(rooms.indexOf(this.props.room));
      ...
      if (this.props.room.code !== 'BAhvZrRwcfu') {
        select = external_react_default.a.createElement("div", null, external_react_default.a.createElement("input", {
          type: "checkbox",
          onChange: getData.bind(null, this.props.room.code, this.props.room)
...
/* harmony default export */ var data_rooms = (rooms_rooms);
