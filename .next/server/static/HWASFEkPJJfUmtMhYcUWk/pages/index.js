  ...
  _createClass(Room4, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        ...
        select = external_react_default.a.createElement("div", null, this.props.fromChildToParentCallback(this.state.check), this.props.fromChildToParentCallback(this.state.room), console.log(this.props), external_react_default.a.createElement("input", {
          type: "checkbox",
          onClick: function onClick() {
            return _this2.getStuff();
          }
