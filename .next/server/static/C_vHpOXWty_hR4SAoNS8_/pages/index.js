...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(Grid, null, external_react_default.a.createElement(Box, null, check, this.props.room.room, select));
    }
  }]);
