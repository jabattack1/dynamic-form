...
function (_React$Component) {
  ...
  function Room1(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "twoCalls", function (e) {
      _this.functionOne(e);
  ...
  _createClass(Room1, [{
    ...
    key: "functionTwo",
    value: function functionTwo(e) {
      console.log('dos');
      console.log(e.target.value);
      document.getElementById('selectionAdults').value = e.target.value;
    }
  }, {
