...
function getData(rooms, number) {
  var target = rooms[number];
  var checkBox = document.getElementById(number);

  if (checkBox.checked) {
    console.log('checked');
    var boolean = rooms[number].check = true;
    renderSelect(boolean);
  } else {
    console.log('unchecked');

    var _boolean = rooms[number].check = false;

    renderSelect(_boolean);
  }
}

function renderSelect(b) {
  if (b === false) {
    document.getElementsByClassName('test').setAttribute("disabled", "disabled");
  } else {
    document.getElementsByClassName('test').removeAttribute("disabled");
  }
}
    ...
    value: function render() {
      ...
      if (this.props.room.code !== 'BAhvZrRwcfu') {
        select = external_react_default.a.createElement("div", null, external_react_default.a.createElement("input", {
          ...
          onChange: getData.bind(null, this.props.rooms, this.props.number)
