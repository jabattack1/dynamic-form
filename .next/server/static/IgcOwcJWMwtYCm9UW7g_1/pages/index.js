...
function (_React$Component) {
  ...
  _createClass(Room1, [{
    ...
    value: function render() {
      ...
      var optionsAdults = '';
      var optionsChildren = '';
      console.log(this.props.data.adults1);
    ...
    value: function getStuff() {
      this.setState({
        ...
        if (this.props.data !== undefined) {
          ...
          console.log('eh');
          this.props.fromChildToParentCallback([this.state.check, this.state.room, this.state.adults, this.props.state.children]);
        }
      });
    }
  }]);
...
function (_React$Component) {
  ...
  _createClass(Room2, [{
    ...
    value: function render() {
      ...
      console.log(this.props.data.children2);
      console.log('screwy');
  ...
  _createClass(Room4, [{
    ...
    value: function render() {
      ...
      if (this.props.data !== null) {
        ...
        } else if (this.props.data.adults4 === 2) {
          optionsAdults = external_react_default.a.createElement("div", null, external_react_default.a.createElement("select", {
            onChange: function onChange(e) {
              return _this2.setState({
                adults: parse_int_default()(e.target.value)
...
function (_React$Component) {
  ...
  function Parent(props) {
    ...
    if (_this.props.peter !== undefined) {
      ;
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      ...
      if (this.props.peter !== undefined) {
        var _chips = this.props.peter;
      } else {
        var _chips2 = this.props;
      }
