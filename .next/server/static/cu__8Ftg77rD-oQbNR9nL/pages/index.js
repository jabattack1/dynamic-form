...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    key: "renderSelect",
    value: function renderSelect(rooms) {
      console.log(rooms);
    }
  }, {
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Grid, null, external_react_default.a.createElement(Box, null, this.props.room.room, this.props.map(this.renderSelect)));
    }
  }]);
