...
var room1_Heading = external_styled_components_default.a.span(_templateObject6());
    ...
    value: function render() {
      ...
      if (this.props.data.props.peter !== null) {
        ...
        if (this.props.data.props.peter.adults1 === 1) {
          optionsAdults = external_react_default.a.createElement("select", {
        ...
        if (this.props.data.props.peter.children1 === 0) {
          optionsChildren = external_react_default.a.createElement("select", {
            onChange: function onChange(e) {
              return _this2.setState({
