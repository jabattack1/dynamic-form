  ...
  _createClass(Room1, [{
    ...
    value: function render() {
      ...
      select = external_react_default.a.createElement(ItemWrap, null, external_react_default.a.createElement(Heading, null, "Room ", this.state.room), external_react_default.a.createElement(Item, null, external_react_default.a.createElement(Slot, null, external_react_default.a.createElement(P, null, "Adults"), external_react_default.a.createElement(P, null, "(18+)"), external_react_default.a.createElement("div", null, external_react_default.a.createElement("select", {
        id: "selection",
        onChange: "{e=>this.setState({adults: parseInt(e.target.value)}, function () {this.props.fromChildToParentCallback([this.state.check, this.state.room, this.state.adults, this.state.children]); })}; {e=>if(process.browser){document.getElementById('selection').value=e.target.value;}}"
      }, external_react_default.a.createElement("option", null, 1), external_react_default.a.createElement("option", null, 2)))), external_react_default.a.createElement(Slot, null, external_react_default.a.createElement(P, null, "Children"), external_react_default.a.createElement(P, null, "(0-17)"), optionsChildren)));
