...
var Box = external_styled_components_default.a.div(_templateObject2()); // function getData(rooms, number){
// 	// let target = rooms[number];
// 	let checkboxes = document.getElementsByName('foo');
// 	let checkBox = document.getElementById(number);
// 	let test = number+1;
// 	// let s = document.getElementsByClassName(number);
// 	if (checkBox.checked){
// 		for(var i=0;i<checkboxes.length-test;i++){
...
function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function changeCheck() {
      console.log(this.state); // this.props.room.setState({
