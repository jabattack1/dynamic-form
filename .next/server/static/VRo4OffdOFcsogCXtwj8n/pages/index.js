...
var grid = external_styled_components_default.a.div(parent_templateObject2());
  ...
  _createClass(Parent, [{
    ...
    value: function render() {
      ...
      if (this.state.checked === 'room2') {
        ...
        children = external_react_default.a.createElement("grid", null, external_react_default.a.createElement(room1, {
          fromChildToParentCallback: room1Value
        }), external_react_default.a.createElement(room2, {
          fromChildToParentCallback: room2Value,
          check: false
