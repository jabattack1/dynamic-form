...
function getData(code, number) {
  ...
  var checkBox = document.getElementById(code); // target.check=!target.check;

  var checkboxes = document.getElementsByTagName('input');
  var node = document.getElementsByName(code); // let s = document.getElementsByClassName(number);
    ...
    value: function render() {
      ...
      if (this.props.room.code !== 'BAhvZrRwcfu') {
        select = external_react_default.a.createElement("div", null, external_react_default.a.createElement("input", {
          type: "checkbox",
          id: this.props.room.code,
          onClick: getData.bind(null, this.props.room.code, this.props.number)
      ...
      return external_react_default.a.createElement(Grid, null, external_react_default.a.createElement(Box, null, this.props.room.room, this.setState({
