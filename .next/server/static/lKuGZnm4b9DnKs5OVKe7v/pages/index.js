  ...
  _createClass(Room4, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        document.getElementsByName('room4').disabled = false;
      } else {
        document.getElementsByName('room4').disabled = true;
      }

      var select = external_react_default.a.createElement("div", null, console.log(this.props.rooms), external_react_default.a.createElement("label", null, external_react_default.a.createElement("input", {
        type: "checkbox",
