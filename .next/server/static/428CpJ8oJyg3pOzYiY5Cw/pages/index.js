...
function (_React$Component) {
  ...
  _createClass(Room2, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(room2_Grid, null, console.log(this.props.rooms), external_react_default.a.createElement(room2_Box, null, this.state.room, select));
    }
  }]);
