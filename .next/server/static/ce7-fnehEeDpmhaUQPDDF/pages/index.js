  ...
  _createClass(Room2, [{
    ...
    value: function render() {
      ...
      if (this.state.check === true) {
        ...
        select = external_react_default.a.createElement(ItemWrapNay, null, external_react_default.a.createElement(ItemNay, null, external_react_default.a.createElement(Heading2, null, "Room ", this.state.room), external_react_default.a.createElement(Checkbox, {
          type: "checkbox",
          onClick: function onClick() {
            return _this2.getStuff();
          }
